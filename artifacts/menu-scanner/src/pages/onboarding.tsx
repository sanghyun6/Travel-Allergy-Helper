            ...
            <div className="space-y-4 mb-8">
              <div className="space-y-2">
                ...
                <Select value={nativeLanguage} onValueChange={setNativeLanguage}>
                  <SelectTrigger id="language" className="h-12 text-base" data-testid="select-native-language">
            ...
            <div className="flex-1 overflow-y-auto pb-4 space-y-6">
              <div className="grid grid-cols-1 gap-3">
                {COMMON_RESTRICTIONS.map(r => (
                  <label
                    key={r}
                    className={`flex items-center p-4 border rounded-xl cursor-pointer transition-colors ${restrictions.includes(r) ? 'border-primary bg-primary/5' : 'hover:bg-muted/50'}`}
                    data-testid={`label-restriction-${r.toLowerCase().replace(/\s+/g, '-')}`}
                  >
                    <Checkbox
              ...
              <div className="pt-4 border-t">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    data-testid="button-add-custom-restriction"
                  >
                    Add
                  </Button>
                </div>
