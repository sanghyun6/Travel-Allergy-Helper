...
import { COMMON_RESTRICTIONS, LANGUAGES } from "./onboarding";
  ...
  return (
    <div className="min-h-[100dvh] pb-24 bg-background flex flex-col max-w-md mx-auto w-full">
      ...
      <div className="p-6 space-y-8 flex-1 overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            {COMMON_RESTRICTIONS.map(r => (
              <label key={r} className={`flex items-center p-4 border rounded-xl cursor-pointer transition-colors ${restrictions.includes(r) ? 'border-primary bg-primary/5' : 'hover:bg-muted/50 bg-card'}`}>
                <Checkbox 
          ...
          <div className="pt-2">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button type="button" variant="secondary" className="h-12 px-6 rounded-xl" onClick={addCustomRestriction}>
                Add
              </Button>
            </div>
          </div>
        ...
        <Button size="lg" className="w-full h-14 text-lg rounded-xl mt-8" onClick={saveSettings}>
          Save Changes
        </Button>
      </div>
    </div>
